          ...
          <Card className="text-center py-12">
            <CardContent>
              ...
              <p className="text-muted-foreground">
                There are no potential matches available at this time. Check back later!
              </p>
            </CardContent>
          </Card>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-4">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <h2 className="text-2xl font-bold">{matches[currentMatchIndex].name}, {matches[currentMatchIndex].age}</h2>
                      {matches[currentMatchIndex].program && (
                        <p className="text-sm text-slate-500">{matches[currentMatchIndex].program}</p>
                      )}
                    </div>
